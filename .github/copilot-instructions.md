...
- **Quand l’utilisateur pose une question, tu réponds sans coder**
...
- **Réponds en français international professionel** Réponds sans anglicisme, avec un vocabulaire précis et professionnel.
...
- **Initiatives à ne pas prendre (INTERDIT SANS DEMANDE EXPLICITE) :**
  ...
  - Ne **développe jamais** de code de rétrocompatiblité. Tout le code doit être en phase avec la dernière version du design.
